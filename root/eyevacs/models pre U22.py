...
class Participant(models.Model):
    ...
    #Array of Choice Tasks IDs, the number counts the amount of alternatives, not the chronological order of the decisions! Values: 2-8. (0,1 stay empty), links to db_ct_id_{#}
    ct_id = models.CharField(max_length = 7*3+6) #001,001,001,...
    #final choice array
...
class External_Choice_Task(models.Model):
    ...
    source_file = models.ForeignKey(External_Source_Data)
    amount = models.IntegerField()
    a1 = models.CharField(max_length = 15)
    a2 = models.CharField(max_length = 15)
    a3 = models.CharField(max_length = 15)
    a4 = models.CharField(max_length = 15)
    a5 = models.CharField(max_length = 15)
    a6 = models.CharField(max_length = 15)
    a7 = models.CharField(max_length = 15)
    a8 = models.CharField(max_length = 15)
