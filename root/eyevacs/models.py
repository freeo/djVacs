...
class Participant(models.Model):
    ...
    total_time = models.CharField(max_length=100, default='99:99')
    ...
    t_rnd_max = models.CharField(max_length=50, default='99:99')
    ...
    t_rnd_regret = models.CharField(max_length=50, default='99:99')
    ...
    t_experience = models.CharField(max_length=50, default='99:99')
    ...
    t_rnd_involvement = models.CharField(max_length=50, default='99:99')

    explanation_distance = models.CharField(max_length=100)
    t_expl_distance = models.CharField(max_length=50, default='99:99')
    explanation_food = models.CharField(max_length=100)
    t_expl_food = models.CharField(max_length=50, default='99:99')
    explanation_price = models.CharField(max_length=100)
    t_expl_price = models.CharField(max_length=50, default='99:99')
    explanation_recommend = models.CharField(max_length=100)
    t_expl_recommend = models.CharField(max_length=50, default='99:99')
    explanation_room = models.CharField(max_length=100)
    t_expl_room = models.CharField(max_length=50, default='99:99')
    explanation_view = models.CharField(max_length=100)
    t_expl_view = models.CharField(max_length=50, default='99:99')
    ...
    t_expl_fav = models.CharField(max_length=50, default='99:99')
    #the final decision
    ...
    t_h1page1 = models.CharField(max_length=50, default='99:99')
    ...
    t_h1page2 = models.CharField(max_length=50, default='99:99')
    ...
    t_h2transitdecision = models.CharField(max_length=50, default='99:99')
    ...
    t_rnd_searchgoals = models.CharField(max_length=50, default='99:99')
    #OPTIONAL EXPORT
    ...
    t_rnd_happiness = models.CharField(max_length=50, default='99:99')

    demo_gender = models.CharField(max_length=6, choices= GENDER_CHOICES)
    demo_age = models.IntegerField()
    t_demographics = models.CharField(max_length=50, default='99:99')
