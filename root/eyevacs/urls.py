...
urlpatterns = patterns('eyevacs.views',
    ...
    url(r'^defaultnewpcpt/$','defaultMelbournePcpt'),
    ...
    url( pcptID % r'pl_difficulty_last/','pl_difficulty_last'),
    url( pcptID % r'holdout/(?P<holdout_page>\d)/','holdout'),
    url( pcptID % r'holdout/loading/','loading_holdout'),
    ...
    url( pcptID % r'favorite_package/','favorite_package'),
