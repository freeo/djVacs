...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.total_time'
        db.add_column('eyevacs_participant', 'total_time',
                      self.gf('django.db.models.fields.CharField')(default='9999', max_length=100),
                      keep_default=False)

        # Adding field 'Participant.raw_timestamps'
        db.add_column('eyevacs_participant', 'raw_timestamps',
                      self.gf('django.db.models.fields.TextField')(default='not assigned'),
                      keep_default=False)


        # Changing field 'Participant.t_rnd_searchgoals'
        db.alter_column('eyevacs_participant', 't_rnd_searchgoals', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_expl_room'
        db.alter_column('eyevacs_participant', 't_expl_room', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_h1page1'
        db.alter_column('eyevacs_participant', 't_h1page1', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_h1page2'
        db.alter_column('eyevacs_participant', 't_h1page2', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_rnd_max'
        db.alter_column('eyevacs_participant', 't_rnd_max', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_h2transitdecision'
        db.alter_column('eyevacs_participant', 't_h2transitdecision', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_demographics'
        db.alter_column('eyevacs_participant', 't_demographics', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_rnd_regret'
        db.alter_column('eyevacs_participant', 't_rnd_regret', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_expl_price'
        db.alter_column('eyevacs_participant', 't_expl_price', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_expl_recommend'
        db.alter_column('eyevacs_participant', 't_expl_recommend', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_expl_view'
        db.alter_column('eyevacs_participant', 't_expl_view', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_expl_distance'
        db.alter_column('eyevacs_participant', 't_expl_distance', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_experience'
        db.alter_column('eyevacs_participant', 't_experience', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_rnd_involvement'
        db.alter_column('eyevacs_participant', 't_rnd_involvement', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_expl_fav'
        db.alter_column('eyevacs_participant', 't_expl_fav', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_rnd_happiness'
        db.alter_column('eyevacs_participant', 't_rnd_happiness', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Participant.t_expl_food'
        db.alter_column('eyevacs_participant', 't_expl_food', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):
        # Deleting field 'Participant.total_time'
        db.delete_column('eyevacs_participant', 'total_time')

        # Deleting field 'Participant.raw_timestamps'
        db.delete_column('eyevacs_participant', 'raw_timestamps')


        # Changing field 'Participant.t_rnd_searchgoals'
        db.alter_column('eyevacs_participant', 't_rnd_searchgoals', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_expl_room'
        db.alter_column('eyevacs_participant', 't_expl_room', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_h1page1'
        db.alter_column('eyevacs_participant', 't_h1page1', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_h1page2'
        db.alter_column('eyevacs_participant', 't_h1page2', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_rnd_max'
        db.alter_column('eyevacs_participant', 't_rnd_max', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_h2transitdecision'
        db.alter_column('eyevacs_participant', 't_h2transitdecision', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_demographics'
        db.alter_column('eyevacs_participant', 't_demographics', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_rnd_regret'
        db.alter_column('eyevacs_participant', 't_rnd_regret', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_expl_price'
        db.alter_column('eyevacs_participant', 't_expl_price', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_expl_recommend'
        db.alter_column('eyevacs_participant', 't_expl_recommend', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_expl_view'
        db.alter_column('eyevacs_participant', 't_expl_view', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_expl_distance'
        db.alter_column('eyevacs_participant', 't_expl_distance', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_experience'
        db.alter_column('eyevacs_participant', 't_experience', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_rnd_involvement'
        db.alter_column('eyevacs_participant', 't_rnd_involvement', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_expl_fav'
        db.alter_column('eyevacs_participant', 't_expl_fav', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_rnd_happiness'
        db.alter_column('eyevacs_participant', 't_rnd_happiness', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Participant.t_expl_food'
        db.alter_column('eyevacs_participant', 't_expl_food', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'eyevacs.grouping': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_hole_history': ('django.db.models.fields.TextField', [], {'null': 'True'}),
