...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.validated_pretest'
        db.add_column('eyevacs_participant', 'validated_pretest',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'External_Source_Data.header'
        db.alter_column('eyevacs_external_source_data', 'header', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Adding field 'Grouping.id_hole_history'
        db.add_column('eyevacs_grouping', 'id_hole_history',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.validated_pretest'
        db.delete_column('eyevacs_participant', 'validated_pretest')


        # Changing field 'External_Source_Data.header'
        db.alter_column('eyevacs_external_source_data', 'header', self.gf('django.db.models.fields.CharField')(max_length=100))
        # Deleting field 'Grouping.id_hole_history'
        db.delete_column('eyevacs_grouping', 'id_hole_history')
