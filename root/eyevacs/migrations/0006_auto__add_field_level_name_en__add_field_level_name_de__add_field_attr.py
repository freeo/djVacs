...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('eyevacs_level', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Level.name_de'
        db.add_column('eyevacs_level', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Attribute.name_en'
        db.add_column('eyevacs_attribute', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Attribute.name_de'
        db.add_column('eyevacs_attribute', 'name_de',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('eyevacs_level', 'name_en')

        # Deleting field 'Level.name_de'
        db.delete_column('eyevacs_level', 'name_de')

        # Deleting field 'Attribute.name_en'
        db.delete_column('eyevacs_attribute', 'name_en')

        # Deleting field 'Attribute.name_de'
        db.delete_column('eyevacs_attribute', 'name_de')
