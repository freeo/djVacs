...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'External_Order_Scale.source_file'
        db.add_column('eyevacs_external_order_scale', 'source_file',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eyevacs.External_Source_Data'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'External_Order_Scale.source_file'
        db.delete_column('eyevacs_external_order_scale', 'source_file_id')
