...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Participant.rnd_searchgoalsQ3'
        db.alter_column('eyevacs_participant', 'rnd_searchgoalsQ3', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Participant.rnd_searchgoalsQ4'
        db.alter_column('eyevacs_participant', 'rnd_searchgoalsQ4', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Participant.rnd_searchgoalsQ2'
        db.alter_column('eyevacs_participant', 'rnd_searchgoalsQ2', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Participant.rnd_searchgoalsQ1'
        db.alter_column('eyevacs_participant', 'rnd_searchgoalsQ1', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Participant.rnd_searchgoalsQ3'
        db.alter_column('eyevacs_participant', 'rnd_searchgoalsQ3', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Participant.rnd_searchgoalsQ4'
        db.alter_column('eyevacs_participant', 'rnd_searchgoalsQ4', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Participant.rnd_searchgoalsQ2'
        db.alter_column('eyevacs_participant', 'rnd_searchgoalsQ2', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Participant.rnd_searchgoalsQ1'
        db.alter_column('eyevacs_participant', 'rnd_searchgoalsQ1', self.gf('django.db.models.fields.IntegerField')())
