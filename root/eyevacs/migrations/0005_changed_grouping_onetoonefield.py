...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Grouping.experiment'
        db.alter_column('eyevacs_grouping', 'experiment_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['eyevacs.Experiment'], unique=True))
        # Adding unique constraint on 'Grouping', fields ['experiment']
        db.create_unique('eyevacs_grouping', ['experiment_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Grouping', fields ['experiment']
        db.delete_unique('eyevacs_grouping', ['experiment_id'])


        # Changing field 'Grouping.experiment'
        db.alter_column('eyevacs_grouping', 'experiment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eyevacs.Experiment']))
