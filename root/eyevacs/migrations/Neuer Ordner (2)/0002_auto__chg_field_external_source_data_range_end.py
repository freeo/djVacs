...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'External_Source_Data.range_end'
        db.alter_column('eyevacs_external_source_data', 'range_end', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'External_Source_Data.range_end'
        db.alter_column('eyevacs_external_source_data', 'range_end', self.gf('django.db.models.fields.IntegerField')(default=None))
