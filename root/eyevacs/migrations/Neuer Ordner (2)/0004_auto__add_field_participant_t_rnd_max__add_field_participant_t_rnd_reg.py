...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.t_rnd_max'
        db.add_column('eyevacs_participant', 't_rnd_max',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)

        # Adding field 'Participant.t_rnd_regret'
        db.add_column('eyevacs_participant', 't_rnd_regret',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)

        # Adding field 'Participant.t_experience'
        db.add_column('eyevacs_participant', 't_experience',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)

        # Adding field 'Participant.t_rnd_involvement'
        db.add_column('eyevacs_participant', 't_rnd_involvement',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Participant.t_h1page1'
        db.add_column('eyevacs_participant', 't_h1page1',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)

        # Adding field 'Participant.t_h1page2'
        db.add_column('eyevacs_participant', 't_h1page2',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)

        # Adding field 'Participant.t_h2transitdecision'
        db.add_column('eyevacs_participant', 't_h2transitdecision',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)

        # Adding field 'Participant.t_rnd_searchgoals'
        db.add_column('eyevacs_participant', 't_rnd_searchgoals',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)

        # Adding field 'Participant.t_rnd_happiness'
        db.add_column('eyevacs_participant', 't_rnd_happiness',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)

        # Adding field 'Participant.t_demographics'
        db.add_column('eyevacs_participant', 't_demographics',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, blank=True),
                      keep_default=False)


        # Changing field 'Participant.end_time'
        db.alter_column('eyevacs_participant', 'end_time', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Participant.t_rnd_max'
        db.delete_column('eyevacs_participant', 't_rnd_max')

        # Deleting field 'Participant.t_rnd_regret'
        db.delete_column('eyevacs_participant', 't_rnd_regret')

        # Deleting field 'Participant.t_experience'
        db.delete_column('eyevacs_participant', 't_experience')

        # Deleting field 'Participant.t_rnd_involvement'
        db.delete_column('eyevacs_participant', 't_rnd_involvement')
        ...
        # Deleting field 'Participant.t_h1page1'
        db.delete_column('eyevacs_participant', 't_h1page1')

        # Deleting field 'Participant.t_h1page2'
        db.delete_column('eyevacs_participant', 't_h1page2')

        # Deleting field 'Participant.t_h2transitdecision'
        db.delete_column('eyevacs_participant', 't_h2transitdecision')

        # Deleting field 'Participant.t_rnd_searchgoals'
        db.delete_column('eyevacs_participant', 't_rnd_searchgoals')

        # Deleting field 'Participant.t_rnd_happiness'
        db.delete_column('eyevacs_participant', 't_rnd_happiness')

        # Deleting field 'Participant.t_demographics'
        db.delete_column('eyevacs_participant', 't_demographics')


        # Changing field 'Participant.end_time'
        db.alter_column('eyevacs_participant', 'end_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'eyevacs.participant': {
            ...
            't_demographics': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_experience': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_expl_distance': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_expl_fav': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_expl_food': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_expl_price': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_expl_recommend': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_expl_room': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_expl_view': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_h1page1': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_h1page2': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_h2transitdecision': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_rnd_happiness': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_rnd_involvement': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_rnd_max': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_rnd_regret': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            't_rnd_searchgoals': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
