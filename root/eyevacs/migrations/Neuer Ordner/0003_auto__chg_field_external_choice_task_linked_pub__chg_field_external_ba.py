...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'External_Choice_Task.linked_pub'
        db.alter_column('eyevacs_external_choice_task', 'linked_pub_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['eyevacs.Pub']))

        # Changing field 'External_Baseline_Choice_Task.linked_pub'
        db.alter_column('eyevacs_external_baseline_choice_task', 'linked_pub_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['eyevacs.Pub']))

    def backwards(self, orm):

        # Changing field 'External_Choice_Task.linked_pub'
        db.alter_column('eyevacs_external_choice_task', 'linked_pub_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['eyevacs.Participant']))

        # Changing field 'External_Baseline_Choice_Task.linked_pub'
        db.alter_column('eyevacs_external_baseline_choice_task', 'linked_pub_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['eyevacs.Participant']))
