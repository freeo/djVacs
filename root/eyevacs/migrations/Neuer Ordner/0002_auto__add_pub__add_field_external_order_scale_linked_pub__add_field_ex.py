...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'External_Order_Scale.linked_pub'
        db.add_column('eyevacs_external_order_scale', 'linked_pub',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eyevacs.Pub'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'External_Order_Scale.used'
        db.add_column('eyevacs_external_order_scale', 'used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'External_Baseline_Choice_Task.linked_pub'
        db.add_column('eyevacs_external_baseline_choice_task', 'linked_pub',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Baseline_Choice_TasksAsPub', null=True, to=orm['eyevacs.Participant']),
                      keep_default=False)

        # Adding field 'External_Choice_Task.linked_pub'
        db.add_column('eyevacs_external_choice_task', 'linked_pub',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Choice_TasksAsPub', null=True, to=orm['eyevacs.Participant']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'External_Order_Scale.linked_pub'
        db.delete_column('eyevacs_external_order_scale', 'linked_pub_id')

        # Deleting field 'External_Order_Scale.used'
        db.delete_column('eyevacs_external_order_scale', 'used')

        # Deleting field 'External_Baseline_Choice_Task.linked_pub'
        db.delete_column('eyevacs_external_baseline_choice_task', 'linked_pub_id')

        # Deleting field 'External_Choice_Task.linked_pub'
        db.delete_column('eyevacs_external_choice_task', 'linked_pub_id')
    ...
    models = {
        ...
        'eyevacs.external_baseline_choice_task': {
            ...
            'linked_pub': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Baseline_Choice_TasksAsPub'", 'null': 'True', 'to': "orm['eyevacs.Participant']"}),
        ...
        'eyevacs.external_choice_task': {
            ...
            'linked_pub': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Choice_TasksAsPub'", 'null': 'True', 'to': "orm['eyevacs.Participant']"}),
            'raw_src_line': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'used': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
