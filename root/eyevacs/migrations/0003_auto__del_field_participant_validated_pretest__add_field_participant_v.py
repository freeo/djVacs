...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Participant.valid_pcpt'
        db.add_column('eyevacs_participant', 'valid_pcpt',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Participant.valid_pcpt'
        db.delete_column('eyevacs_participant', 'valid_pcpt')
