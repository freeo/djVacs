...
rnd_max_questions = ['When I am in the car listening to the radio, I often check other stations to see if something better is playing, even if I am relatively satisfied with what I’m listening to.','No matter how satisfied I am with my job, it’s only right for me to be on the lookout for better opportunities.','I often find it difficult to shop for a gift for a friend.','Renting videos is really difficult. I’m always struggling to pick the best one.','No matter what I do, I have the highest standards for myself.','I never settle for second best.']
rnd_regret_questions = ['Whenever I make a choice, I’m curious about what would have happened if I had chosen differently.', 'Whenever I make a choice, I try to get information about how the other alternatives turned out.', 'If I make a choice and it turns out well, I still feel like something of a failure if I find out that another choice would have turned out better.', 'When I think about how I’m doing in life, I often assess opportunities I have passed up.', 'Once I make a decision, I don’t look back.']
rnd_involvement_questions = ['Overall, how familiar are you with booking vacation packages?', 'The decision which vacation package to buy is a', 'The decision which vacation package to buy', 'When booking a vacation package there is' ]
rnd_searchgoals_questions = ['Even if I found a vacation package that I was relatively satisfied with, I still looked to the other available vacation packages before deciding.', 'I tried to find the best vacation package in each of the previous choice tasks.', 'I had in mind some ideal vacation package(s), and I tried to look for vacation packages similar to my ideal package(s).', 'I made my decision in each choice task as soon as I found a vacation package that was good enough. ']
...
rnd_searchgoals_title = 'Now let’s come back to the hotel choices you made for you and your friend with the money you got from your rich relative (the $2000). We’d like to learn how you proceeded when making these choices:\n\nPlease indicate your degree of agreement with the following statements (-3 = I do not agree with the statement at all, +3 = I agree with the statement very much)'
...
########################################################################
#
# rnd_max_caption = [{'left':'I do not agree at all','right':'I agree very much'},{'left':'I do not agree at all','right':'I agree very much'},{'left':'I do not agree at all','right':'I agree very much'},{'left':'I do not agree at all','right':'I agree very much'},{'left':'I do not agree at all','right':'I agree very much'},{'left':'I do not agree at all','right':'I agree very much'}]
...
rnd_involvement_caption = [{'left':'very unfamiliar','right':'very familiar'},{'left':'very unimportant decision','right':'very important decision'},{'left':'requires little thought','right':'requires a lot of thought'},{'left':'little to lose if you choose the wrong package','right':'a lot to lose if you choose the wrong package'}]
rnd_searchgoals_caption = [{'left':'','right':''},{'left':'','right':''},{'left':'','right':''},{'left':'','right':''}]
rnd_happiness_caption = [{'left':'not a very happy person','right':'a very happy person'},{'left':'less happy','right':'more happy'},{'left':'not at all','right':'great deal'},{'left':'not at all','right':'a great deal'}]
