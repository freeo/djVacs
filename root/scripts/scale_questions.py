...
rnd_involvement_questions = [ugettext_lazy(u'Overall, how familiar are you with booking vacation packages?'), ugettext_lazy(u'The decision which vacation package to buy is a'), ugettext_lazy(u'The decision which vacation package to buy'), ugettext_lazy(u'When booking a vacation package there is') ]
rnd_searchgoals_questions = [ugettext_lazy(u'Even if I found a vacation package that I was relatively satisfied with, I still looked to the other available vacation packages before deciding.'), ugettext_lazy(u'I tried to find the best vacation package in each of the previous choice tasks.'), ugettext_lazy(u'I had in mind some ideal vacation package(s), and I tried to look for vacation packages similar to my ideal package(s).'), ugettext_lazy(u'I made my decision in each choice task as soon as I found a vacation package that was good enough. ')]
